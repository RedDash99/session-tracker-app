...
export default function Field({ name, type, placeholder, required = false, ...props }) {
  const {
    register,
    watch,
    formState: { errors },
  ...
  return (
    <div className={styles.field}>
      ...
      {errors?.[name] && (
        <span className={styles.error} title={errors[name].message}>
          <svg
            width="24"
            height="25"
            viewBox="0 0 24 25"
